...
- **listing-detail.tsx:** Passes `listingRef`, `listingMaterial`, `listingQuantity`, `myCompanyName` to DealPanel for print reports; `listing_id` is included in DealInfo and deal serializer.
