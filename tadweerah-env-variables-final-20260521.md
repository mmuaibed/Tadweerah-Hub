# Tadweerah — Environment Variables Reference

> Names only — no secret values included.
> Last updated: 2026-05-21 (post admin email update)
...
| `VITE_TADWEERAH_ADMIN_EMAILS` | Required | Comma-separated Clerk email addresses with admin panel access. Current value: mmuaibed@outlook.com |
