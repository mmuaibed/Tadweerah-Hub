...
const translations: Record<string, Record<Language, string>> = {
  ...
  "listing.form.material_location_address.placeholder": { ar: "مثال: FMDD7920 أو حي الصناعية، الجبيل الصناعية", en: "e.g. FMDD7920 or Industrial District, Jubail" },
  "listing.form.material_location_notes": { ar: "تفاصيل الموقع (اختياري)", en: "Site Details (Optional)" },
  "listing.form.material_location_notes.placeholder": { ar: "مثال: بوابة 3، المستودع الخلفي، تواصل مع حارس الأمن", en: "e.g. Gate 3, rear warehouse, contact security guard" },
  "listing.form.google_maps_url": { ar: "رابط Google Maps (اختياري)", en: "Google Maps URL (optional)" },
  ...
  "admin.quotes.select":                   { ar: "اختيار", en: "Select" },
