...
const translations: Record<string, Record<Language, string>> = {
  ...
  "listing.form.material_location_address": { ar: "العنوان الوطني / وصف موقع المواد", en: "National Address / Material Location Description" },
  "listing.form.material_location_address.placeholder": { ar: "مثال: حي الصناعية، الجبيل الصناعية، المنطقة الشرقية", en: "e.g. Industrial District, Jubail Industrial City" },
  "listing.form.google_maps_url": { ar: "رابط الموقع على Google Maps (اختياري)", en: "Google Maps Location URL (optional)" },
  ...
  "listing.location.address": { ar: "موقع المواد", en: "Material Location" },
