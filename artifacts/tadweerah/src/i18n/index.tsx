...
const translations: Record<string, Record<Language, string>> = {
  ...
  "publicHome.brand.aria": { ar: "تدويرة — Tadweerah — الصفحة الرئيسية", en: "Tadweerah — تدويرة — Home" },
  "publicHome.brand.alt": { ar: "تدويرة — Tadweerah", en: "Tadweerah — تدويرة" },
  "publicHome.nav.aria": { ar: "روابط الصفحة الرئيسية", en: "Homepage navigation" },
  "publicHome.nav.menu": { ar: "القائمة", en: "Menu" },
  "publicHome.nav.home": { ar: "الرئيسية", en: "Home" },
  "publicHome.nav.how": { ar: "كيف تعمل", en: "How it works" },
  "publicHome.nav.services": { ar: "الخدمات", en: "Services" },
  "publicHome.nav.audience": { ar: "لمن؟", en: "Who it's for" },
  "publicHome.nav.compliance": { ar: "الامتثال", en: "Compliance" },
  "publicHome.nav.about": { ar: "عن تدويرة", en: "About" },
  "publicHome.nav.contact": { ar: "تواصل معنا", en: "Contact" },
  "publicHome.action.language": { ar: "English", en: "العربية" },
  "publicHome.action.login": { ar: "تسجيل الدخول", en: "Log in" },
  "publicHome.action.register": { ar: "سجّل شركتك", en: "Register" },
  "publicHome.action.registerCompany": { ar: "سجّل شركتك", en: "Register your company" },
  "publicHome.action.registerNow": { ar: "سجّل شركتك الآن", en: "Register your company now" },
  "publicHome.action.seeHow": { ar: "شاهد كيف تعمل", en: "See how it works" },
  "publicHome.action.whatsapp": { ar: "تواصل معنا عبر واتساب", en: "Contact us on WhatsApp" },

  "publicHome.hero.eyebrow": { ar: "منصة سعودية للاقتصاد الدائري · B2B", en: "Saudi B2B Circular Economy Platform" },
  "publicHome.hero.line1": { ar: "حوّل فائض موادك إلى قيمة", en: "Turn your material surplus into" },
  "publicHome.hero.line2": { ar: "مُستردّة وموثّقة", en: "documented, recovered value" },
  "publicHome.hero.body": {
    ar: "منصة سعودية تربط مولّدي المواد بالمعالجين والناقلين المؤهّلين، وتوثّق الصفقة والنقل وتقارير الاستدامة — في مسار واحد قابل للتتبّع.",
    en: "A Saudi platform connecting material generators with qualified processors and transporters, documenting deals, transport, and sustainability reporting in one traceable workflow.",
  },
  "publicHome.hero.note": {
    ar: "للشركات فقط · بدون التزام · تواصل معنا لتفعيل منشأتك",
    en: "For businesses only · No commitment · Contact us to activate your facility",
  },

  "publicHome.mockup.aria": {
    ar: "لقطة توضيحية من منصة تدويرة تعرض فرص مواد، حالة صفقة موثّقة، تتبّع نقل، وبطاقة تقرير استدامة — عيّنة توضيحية وليست بيانات حقيقية",
    en: "Illustrative Tadweerah platform snapshot showing material opportunities, documented deal status, transport tracking, and a sustainability report card — sample data, not real data",
  },
  "publicHome.mockup.listing": { ar: "فرصة مواد", en: "Material listing" },
  "publicHome.mockup.open": { ar: "متاحة", en: "Open" },
  "publicHome.mockup.review": { ar: "مراجعة", en: "Review" },
  "publicHome.mockup.pp": { ar: "بولي بروبيلين — PP", en: "Polypropylene — PP" },
  "publicHome.mockup.ppMeta": { ar: "المنطقة الشرقية · ١٢ طن · عيّنة", en: "Eastern Province · 12 t · sample" },
  "publicHome.mockup.hdpe": { ar: "HDPE — بولي إيثيلين", en: "HDPE — Polyethylene" },
  "publicHome.mockup.hdpeMeta": { ar: "الرياض · ٨ طن · عيّنة", en: "Riyadh · 8 t · sample" },
  "publicHome.mockup.dealStatus": { ar: "حالة الصفقة", en: "Deal status" },
  "publicHome.mockup.documented": { ar: "موثّقة", en: "Documented" },
  "publicHome.mockup.offer": { ar: "عرض", en: "Offer" },
  "publicHome.mockup.deal": { ar: "اتفاق", en: "Deal" },
  "publicHome.mockup.transport": { ar: "نقل", en: "Transport" },
  "publicHome.mockup.close": { ar: "إغلاق", en: "Close" },
  "publicHome.mockup.report": { ar: "تقرير الاستدامة", en: "Sustainability report" },
  "publicHome.mockup.quality": { ar: "جودة عالية", en: "High quality" },
  "publicHome.mockup.reportNote": { ar: "كمية مُستردّة · عيّنة توضيحية", en: "Recovered volume · sample data" },
  "publicHome.mockup.float": { ar: "مسار موثّق · من المصدر إلى المعالجة", en: "Documented path · source to processing" },
  "publicHome.mockup.sample": { ar: "عيّنة توضيحية", en: "Sample data" },

  "publicHome.trust.aria": { ar: "خصائص الثقة في تدويرة", en: "Tadweerah trust signals" },
  "publicHome.trust.saudi": { ar: "منصة سعودية", en: "Saudi platform" },
  "publicHome.trust.business": { ar: "مخصصة للشركات", en: "Built for businesses" },
  "publicHome.trust.workflow": { ar: "مسار موثّق", en: "Documented workflow" },
  "publicHome.trust.protected": { ar: "بيانات محمية", en: "Protected data" },
  ...
  "publicHome.how.step1.body": {
    ar: "اعرض موادك القابلة للاسترداد بوصفٍ وكميةٍ واضحة، أو تصفّح فرص المواد المتاحة.",
    en: "List your recoverable materials with clear description and quantity, or browse available material opportunities.",
  },
  "publicHome.how.step2.title": { ar: "تواصل مع الأطراف المؤهّلة", en: "Connect with qualified parties" },
  "publicHome.how.step2.body": {
    ar: "تفاوض مع معالجين ومصانع وناقلين مؤهّلين داخل المنصة، ضمن سياق واضح ومنظّم.",
    en: "Negotiate with qualified processors, factories, and transporters inside the platform, in a clear and organized context.",
  },
  "publicHome.how.step3.title": { ar: "وثّق الصفقة والنقل", en: "Document the deal and transport" },
  "publicHome.how.step3.body": {
    ar: "سجّل تفاصيل الاتفاق، واربط عملية النقل، واحتفظ بأثرٍ موثّق لكل خطوة.",
    en: "Record agreement details, link the transport operation, and keep a documented trail for every step.",
  },
  "publicHome.how.step4.title": { ar: "استخرج تقارير الاستدامة", en: "Generate sustainability reports" },
  "publicHome.how.step4.body": {
    ar: "حوّل نشاطك التشغيلي إلى بيانات وتقارير تدعم متطلبات الاستدامة والامتثال.",
    en: "Turn your operational activity into data and reports supporting sustainability and compliance needs.",
  },

  "publicHome.services.eyebrow": { ar: "خدمات المنصة", en: "Platform services" },
  "publicHome.services.title": { ar: "كل ما تحتاجه لإدارة دورة مواد منشأتك", en: "Everything you need to manage your facility's material cycle" },
  "publicHome.services.market.title": { ar: "سوق المواد القابلة للاسترداد", en: "Recoverable materials marketplace" },
  "publicHome.services.market.body": {
    ar: "اعرض موادك أو ابحث عنها بكميات وأوصاف واضحة، وافتح فرص قيمة جديدة لمنشأتك.",
    en: "List or find materials with clear quantities and descriptions, and open new value opportunities for your facility.",
  },
  "publicHome.services.deals.title": { ar: "إدارة الصفقات والمطالبات", en: "Deal and claim management" },
  "publicHome.services.deals.body": {
    ar: "تابع كل صفقة من العرض حتى الإغلاق، بسجلٍّ واضح للمطالبات والموافقات والأطراف.",
    en: "Track every deal from offer to close, with a clear record of claims, approvals, and parties.",
  },
  "publicHome.services.transport.title": { ar: "ربط النقل والتسليم", en: "Transport and delivery coordination" },
  "publicHome.services.transport.body": {
    ar: "اربط صفقاتك بناقلين مؤهّلين ضمن المنظومة، بطلبات نقل وحالات تسليم واضحة وموثّقة.",
    en: "Link your deals to qualified carriers in the network, with clear and documented transport requests and delivery statuses.",
  },
  "publicHome.services.reports.title": { ar: "تقارير الاستدامة", en: "Sustainability reporting" },
  "publicHome.services.reports.body": {
    ar: "حوّل نشاطك التشغيلي إلى تقارير بيانات تدعم متطلبات الاستدامة والامتثال لمنشأتك.",
    en: "Turn your operational activity into data reports supporting sustainability and compliance requirements for your facility.",
  },
  "publicHome.services.governance.title": { ar: "التوثيق والحوكمة التشغيلية", en: "Documentation and operational governance" },
  "publicHome.services.governance.body": {
    ar: "احتفظ بأثرٍ منظّم لكل خطوة، بصلاحيات واضحة وفصلٍ تام لبيانات كل منشأة.",
    en: "Keep an organized trail for every step, with clear permissions and full separation of each facility's data.",
  },
  "publicHome.services.ready.title": { ar: "جاهز للبدء؟", en: "Ready to start?" },
  "publicHome.services.ready.body": {
    ar: "سجّل منشأتك وابدأ بتنظيم فرص المواد القابلة للاسترداد اليوم.",
    en: "Register your facility and start organizing recoverable-material opportunities today.",
  },

  "publicHome.audience.eyebrow": { ar: "لمن المنصة", en: "Who it's for" },
  "publicHome.audience.title": { ar: "مصمّمة لكل طرف في دورة المواد", en: "Designed for every party in the material cycle" },
  "publicHome.audience.lead": {
    ar: "سواء كنت مولّداً للمواد، معالجاً، أو ناقلاً — تدويرة بنيت لدورك تحديداً.",
    en: "Whether you generate materials, process them, or transport them — Tadweerah is built specifically for your role.",
  },
  "publicHome.audience.generators.title": { ar: "مولّدو المواد والمخلفات", en: "Material and waste generators" },
  "publicHome.audience.generators.body": {
    ar: "حوّل الفائض التشغيلي إلى قيمة مُستردّة، مع أثرٍ موثّق يدعم الامتثال وتقارير الاستدامة.",
    en: "Turn operational surplus into recovered value, with a documented trail supporting compliance and sustainability reports.",
  },
  "publicHome.audience.generators.p1": { ar: "اعرض فائض موادك بوصف وكمية واضحة", en: "List surplus materials with clear description and quantity" },
  "publicHome.audience.generators.p2": { ar: "تتبّع الصفقة والنقل في مسار موثّق", en: "Track deals and transport in a documented workflow" },
  "publicHome.audience.generators.p3": { ar: "استخرج تقارير استدامة من بياناتك التشغيلية", en: "Generate sustainability reports from your operational data" },
  "publicHome.audience.processors.title": { ar: "المعالجون والمصانع", en: "Processors and factories" },
  "publicHome.audience.processors.body": {
    ar: "أمّن مدخلاتٍ موثوقة لتغذية عملياتك، وافتح فرصاً أوسع للقيمة الدائرية في قطاعك.",
    en: "Secure reliable inputs to feed your operations, and open wider circular value opportunities in your sector.",
  },
  "publicHome.audience.processors.p1": { ar: "استكشف مواد متاحة مع وصف وكمية دقيقة", en: "Explore available materials with precise description and quantity" },
  "publicHome.audience.processors.p2": { ar: "قدّم عروضاً موثّقة وتابع الصفقات بوضوح", en: "Submit documented offers and track deals clearly" },
  "publicHome.audience.processors.p3": { ar: "احتفظ ببيانات المدخلات في مسار قابل للتتبّع", en: "Keep input data in a traceable workflow" },
  "publicHome.audience.transporters.title": { ar: "الناقلون ومقدّمو الخدمات اللوجستية", en: "Transporters and logistics providers" },
  "publicHome.audience.transporters.body": {
    ar: "انضمّ إلى منظومة نقل تربطك بالمولّدين والمعالجين، بطلبات واضحة وموثّقة في مسار منظّم.",
    en: "Join a transport network connecting you to generators and processors, with clear and documented requests in an organized workflow.",
  },
  "publicHome.audience.transporters.p1": { ar: "استقبل طلبات نقل واضحة ومربوطة بصفقات موثّقة", en: "Receive clear transport requests linked to documented deals" },
  "publicHome.audience.transporters.p2": { ar: "وثّق رحلات التسليم وأكمل المسار بشفافية", en: "Document delivery trips and complete the workflow transparently" },
  "publicHome.audience.transporters.p3": { ar: "احتفظ بسجل عمليات منظّم لكل طرف", en: "Keep an organized operations record for every party" },

  "publicHome.compliance.eyebrow": { ar: "الامتثال والخصوصية", en: "Compliance and privacy" },
  "publicHome.compliance.title": { ar: "الامتثال والخصوصية في صميم التصميم", en: "Compliance and privacy, by design" },
  "publicHome.compliance.item1.title": { ar: "توثيق منظّم في مكان واحد", en: "Organized documentation in one place" },
  "publicHome.compliance.item1.body": {
    ar: "تساعدك تدويرة على تنظيم التوثيق التشغيلي وبيانات الاستدامة في مكان واحد، قابلٍ للرجوع إليه في أي وقت.",
    en: "Tadweerah helps you organize operational documentation and sustainability data in one place, accessible any time.",
  },
  "publicHome.compliance.item2.title": { ar: "خصوصية وتحكّم في الصلاحيات", en: "Privacy and access control" },
  "publicHome.compliance.item2.body": {
    ar: "صُمِّمت المنصة مع مراعاة الخصوصية والتحكّم في الصلاحيات وفصل بيانات كل منشأة على حدة.",
    en: "The platform is designed with privacy, access control, and company-level data separation in mind.",
  },
  "publicHome.compliance.item3.title": { ar: "أثرٌ موثّق لكل خطوة", en: "A documented trail for every step" },
  "publicHome.compliance.item3.body": {
    ar: "كل صفقة ونقل وتقرير يبقى ضمن مسارٍ قابلٍ للتتبّع يسهل الرجوع إليه عند الحاجة.",
    en: "Every deal, transport, and report stays in a traceable workflow you can reference when needed.",
  },
  "publicHome.compliance.disclaimer": {
    ar: "تدويرة تساعد الشركات على تنظيم توثيقها التشغيلي وبياناتها. ولا تدّعي أي اعتماد حكومي أو ترخيص رسمي ما لم يُذكر ذلك صراحةً.",
    en: "Tadweerah helps companies organize their operational documentation and data. It does not claim government endorsement or official license unless explicitly stated.",
  },
  "publicHome.compliance.vaultAria": { ar: "توضيح لمبادئ حماية البيانات في تدويرة", en: "Illustration of Tadweerah data protection principles" },
  "publicHome.compliance.vaultTitle": { ar: "مبادئ حماية البيانات", en: "Data protection principles" },
  "publicHome.compliance.vault.1": { ar: "فصل بيانات كل منشأة على حدة", en: "Each facility's data is kept fully separate" },
  "publicHome.compliance.vault.2": { ar: "صلاحيات محدّدة لكل مستخدم داخل المنشأة", en: "Defined permissions for each user within the facility" },
  "publicHome.compliance.vault.3": { ar: "سجلّ عمليات موثّق يمكن الرجوع إليه", en: "A documented operations log you can revisit" },
  "publicHome.compliance.vault.4": { ar: "دعم التوثيق وتقارير الاستدامة", en: "Documentation and sustainability report support" },

  "publicHome.about.eyebrow": { ar: "عن تدويرة", en: "About Tadweerah" },
  "publicHome.about.title": { ar: "بُنيت لتحويل عمليات المواد إلى قيمة مُوثّقة", en: "Built to turn material operations into documented value" },
  "publicHome.about.body": {
    ar: "تدويرة منصة سعودية B2B تساعد الشركات على استرداد قيمة موادها، وتقليل غموض العمليات، ودعم الانتقال نحو سلاسل عمل أكثر قابلية للتتبّع — بأدوات مصمّمة للسياق السعودي.",
    en: "Tadweerah is a Saudi B2B platform that helps companies recover value from their materials, reduce operational opacity, and support the transition toward more traceable workflows — with tools designed for the Saudi context.",
  },
  "publicHome.about.item1.title": { ar: "استرداد القيمة من المواد", en: "Recovering value from materials" },
  "publicHome.about.item1.body": {
    ar: "نحوّل الفائض التشغيلي إلى فرص قيمة مُعرَّفة وقابلة للتسعير والتتبّع.",
    en: "We turn operational surplus into defined value opportunities that can be priced and tracked.",
  },
  "publicHome.about.item2.title": { ar: "توثيق من المصدر إلى المعالجة", en: "Documentation from source to processing" },
  "publicHome.about.item2.body": {
    ar: "كل خطوة — الصفقة والنقل والتسليم — في مسار موثّق ومنظّم وقابل للرجوع إليه.",
    en: "Every step — deal, transport, delivery — in a documented, organized, and referenceable workflow.",
  },
  "publicHome.about.item3.title": { ar: "مصمّمة للسياق السعودي", en: "Designed for the Saudi context" },
  "publicHome.about.item3.body": {
    ar: "منصة B2B أُسّست لتناسب منظومة الأعمال الصناعية والتشغيلية في المملكة العربية السعودية.",
    en: "A B2B platform founded to fit the industrial and operational business ecosystem in Saudi Arabia.",
  },

  "publicHome.contact.eyebrow": { ar: "تواصل ودعم", en: "Contact and support" },
  "publicHome.contact.title": { ar: "لديك سؤال أو ترغب بتفعيل منشأتك؟", en: "Have a question or want to activate your facility?" },
  "publicHome.contact.lead": {
    ar: "فريقنا جاهز لمساعدتك على فهم الدور الأنسب لمنشأتك على المنصة.",
    en: "Our team is ready to help you find the right role for your facility on the platform.",
  },
  "publicHome.contact.whatsapp.title": { ar: "واتساب", en: "WhatsApp" },
  "publicHome.contact.whatsapp.body": { ar: "تواصل مع فريق تدويرة عبر واتساب", en: "Chat with the Tadweerah team on WhatsApp" },
  "publicHome.contact.email.title": { ar: "البريد الإلكتروني", en: "Email" },
  "publicHome.contact.support.title": { ar: "مركز الدعم", en: "Support center" },
  "publicHome.contact.support.body": { ar: "أرسل استفساراتك عبر البريد", en: "Send your enquiries via email" },

  "publicHome.final.title": { ar: "سجّل شركتك وابدأ بتنظيم فرص المواد القابلة للاسترداد", en: "Register your company and start organizing recoverable-material opportunities" },
  "publicHome.final.body": {
    ar: "تواصل معنا إذا كنت ترغب بتفعيل منشأتك أو فهم الدور الأنسب لك على المنصة.",
    en: "Talk to us if you'd like to activate your facility or understand which role fits you best on the platform.",
  },
  "publicHome.footer.tagline": {
    ar: "منصة سعودية B2B لاسترداد قيمة المواد القابلة للتدوير وتوثيق مسارها.",
    en: "A Saudi B2B platform for recovering the value of recyclable materials and documenting their path.",
  },
  "publicHome.footer.platform": { ar: "المنصة", en: "Platform" },
  "publicHome.footer.supportLegal": { ar: "الدعم والقانوني", en: "Support & legal" },
  "publicHome.footer.support": { ar: "مركز الدعم", en: "Support center" },
  "publicHome.footer.terms": { ar: "الشروط والأحكام", en: "Terms & conditions" },
  "publicHome.footer.privacy": { ar: "سياسة الخصوصية", en: "Privacy policy" },
  "publicHome.footer.rights": { ar: "© 2026 تدويرة. جميع الحقوق محفوظة.", en: "© 2026 Tadweerah. All rights reserved." },
  "publicHome.footer.made": { ar: "صُنع في المملكة العربية السعودية", en: "Made in Saudi Arabia" },
  ...
  "listing.form.material_location_address": { ar: "العنوان الوطني أو رابط موقع المواد", en: "National address or material site link" },
  "listing.form.material_location_address.placeholder": { ar: "مثال: FMD-DMM-IND-TEST-001 أو رابط موقع المنشأة", en: "Example: FMD-DMM-IND-TEST-001 or facility location link" },
  ...
  "listing.form.google_maps_url.invalid": { ar: "الرابط غير صالح — يجب أن يكون رابط Google Maps حقيقياً (مثل maps.google.com)", en: "Invalid URL — must be a real Google Maps link (e.g. maps.google.com)" },
  "listing.location.address": { ar: "العنوان الوطني أو رابط موقع المواد", en: "National address or material site link" },
  ...
  "deal.compliance.deal_number": { ar: "رقم الصفقة", en: "Deal Number" },
  "deal.compliance.listing_ref_label": { ar: "مرجع الإعلان", en: "Listing Reference" },
  ...
  // Admin-only reference clarity/linkability (Phase 1 fix) — distinct from the
  // shared reports.col.* keys above, which are also used on the real
  // company-facing Reports page and must not change meaning there.
  "admin.ref.transport_ref": { ar: "مرجع النقل",  en: "Transport Reference" },
  "admin.ref.internal_id":   { ar: "معرّف داخلي", en: "Internal ID" },
  "admin.ref.view_deal":     { ar: "عرض الصفقة",  en: "View Deal" },
  "admin.ref.no_deal_link":  { ar: "لا يوجد رابط صفقة متاح لهذا السجل", en: "No deal link is available for this record" },
  // Phase 1B additions — founder-visible surfaces (main Deals tab, Contracts, Shipments, source-aware Sustainability action)
  "admin.ref.no_deal_number":     { ar: "لا يوجد رقم صفقة تجاري", en: "No commercial deal number" },
  "admin.ref.no_listing_in_report": { ar: "لا يمكن فتح الصفقة لأن رابط الإعلان غير متوفر في بيانات التقرير", en: "The deal can't be opened because the listing link isn't available in this report's data" },
  "admin.ref.view_contract":  { ar: "عرض العقد",   en: "View Contract" },
  "admin.ref.view_shipment":  { ar: "عرض الشحنة",  en: "View Shipment" },
  "admin.ref.view_source":    { ar: "عرض المصدر",  en: "View Source" },
  "admin.ref.listing_reference": { ar: "مرجع الإعلان", en: "Listing Reference" },
  "admin.ref.no_source_link": { ar: "لا يوجد رابط متاح لهذا المصدر", en: "No link is available for this source" },
  ...
  "contract.weight_policy.source_weight_only": { ar: "وزن المصدر فقط", en: "Source Weight Only" },
  "contract.weight_policy.destination_weight_only": { ar: "وزن الوجهة فقط", en: "Destination Weight Only" },
  "contract.weight_policy.dual_source_final": { ar: "مزدوج - المصدر نهائي", en: "Dual - Source Final" },
  "contract.weight_policy.dual_destination_final": { ar: "مزدوج - الوجهة نهائية", en: "Dual - Destination Final" },
  "contract.weight_policy.dual_higher_final": { ar: "مزدوج - الأعلى نهائي", en: "Dual - Higher Final" },
  "admin.contract.parties_col": { ar: "الطرفان", en: "Parties" },
  "admin.contract.stage_col": { ar: "المرحلة الحالية", en: "Current Stage" },
  ...
  "admin.deal.count_of_total": { ar: "عرض {shown} من أصل {total} صفقة", en: "Showing {shown} of {total} deals" },
  "admin.deal.load_more": { ar: "تحميل المزيد", en: "Load more" },
  ...
  "admin.deal.reference_col": { ar: "رقم الصفقة / العرض", en: "Deal / Offer Ref" },
  "admin.deal.total_amount_col": { ar: "إجمالي المبلغ", en: "Total Amount" },
  "admin.deal.current_stage_col": { ar: "المرحلة الحالية", en: "Current Stage" },
  "admin.deal.amount_not_available": { ar: "غير متوفر", en: "Not available" },
  "admin.deal.subtotal_label": { ar: "المبلغ قبل الضريبة", en: "Before VAT" },
  ...
  "sustainability.allocations.ineligibility.processed_output": { ar: "المادة مخرجات معالجة معاد تدويرها", en: "Material is a recycled processed output" },
  "sustainability.allocations.ineligibility_desc.processed_output": { ar: "هذه المادة غير قابلة للتوزيع لتفادي الحساب المزدوج لأنها منتج معاد تدويره مسبقاً.", en: "This material is ineligible for allocation to avoid double-counting as it is already a recycled product." },
  "sustainability.allocations.ineligibility.unclassified": { ar: "تصنيف المادة غير مكتمل", en: "Material classification incomplete" },
  "sustainability.allocations.ineligibility_desc.unclassified": { ar: "تصنيف المادة غير مكتمل: لم يتم تحديد هل المادة مخرجات معالجة أم مادة قابلة للتوزيع.", en: "Material classification is incomplete: it has not been specified whether the material is a processed output or eligible for allocation." },
  "sustainability.allocations.ineligibility.non_positive_quantity": { ar: "كمية المادة صفر أو أقل", en: "Material quantity is zero or less" },
  ...
  "sustainability.allocations.save_draft": { ar: "حفظ المسودة", en: "Save Draft" },
  "sustainability.allocations.saving": { ar: "جاري الحفظ...", en: "Saving..." },
  "sustainability.allocations.finalize": { ar: "اعتماد بيانات الاستدامة", en: "Finalize Sustainability Data" },
  "sustainability.allocations.finalizing": { ar: "جاري الاعتماد...", en: "Finalizing..." },
  "sustainability.allocations.finalize_warning": { ar: "بعد اعتماد البيانات سيتم قفلها، ولن يمكن تعديلها إلا عبر طلب تصحيح.", en: "After finalization, the data will be locked and can only be modified via a correction request." },
  "sustainability.allocations.status.finalized": { ar: "معتمد", en: "Finalized" },
  "sustainability.allocations.finalized_at": { ar: "تاريخ الاعتماد", en: "Finalized At" },
  "sustainability.allocations.finalized_success": { ar: "تم اعتماد بيانات الاستدامة بنجاح", en: "Sustainability data finalized successfully" },
  "sustainability.allocations.remaining_quantity": { ar: "الكمية المتبقية", en: "Remaining Quantity" },
  "sustainability.allocations.allocated_percentage": { ar: "نسبة التوزيع", en: "Allocated Percentage" },
  "sustainability.allocations.request_change": { ar: "طلب تعديل التوزيع", en: "Request Allocation Change" },
  "sustainability.allocations.request_change.desc": { ar: "تم اعتماد بيانات الاستدامة وقفلها للحفاظ على سلامة السجل. لطلب تعديل التوزيع، يجب تقديم طلب تعديل يخضع لمراجعة وموافقة إدارة تدويرة قبل إعادة فتح السجل.", en: "Sustainability data has been finalized and locked to maintain record integrity. To request an allocation change, a correction request must be submitted for Tadweerah administration review and approval before reopening the record." },
  "sustainability.allocations.contact_support": { ar: "التواصل مع دعم تدويرة", en: "Contact Tadweerah Support" },
  "sustainability.allocations.view_detail": { ar: "عرض التفاصيل", en: "View Details" },
  "sustainability.allocations.total_received": { ar: "الكمية المستلمة الإجمالية", en: "Total Received Quantity" },
  "sustainability.allocations.total_allocated": { ar: "إجمالي التوزيع", en: "Total Allocated" },
  "sustainability.allocations.add_pathway": { ar: "إضافة مسار", en: "Add Pathway" },
  "sustainability.allocations.pathway": { ar: "المسار", en: "Pathway" },
  "sustainability.allocations.explanation_required": { ar: "التوضيح مطلوب", en: "Explanation Required" },
  "sustainability.allocations.explanation_text": { ar: "تفاصيل التوضيح", en: "Explanation Text" },
  "sustainability.allocations.remove": { ar: "إزالة", en: "Remove" },
  ...
  "pathway.recycling.desc": { ar: "معالجة المادة وتحويلها إلى مادة خام أو مدخل إنتاج جديد.", en: "Processing the material and converting it into a raw material or a new production input." },
  "pathway.material_recovery.desc": { ar: "استخراج مواد قابلة للاستفادة من مخلفات مختلطة أو مركبة دون أن تكون العملية إعادة تدوير كاملة بالمعنى التقليدي.", en: "Extracting usable materials from mixed or composite waste without it being a full recycling process in the traditional sense." },
  "pathway.energy_recovery.desc": { ar: "استخدام المادة كمصدر للطاقة أو كوقود بديل، ولا يُحسب كتحويل دائري.", en: "Using the material as an energy source or alternative fuel, not counted as circular diversion." },
  "pathway.safe_treatment.desc": { ar: "معالجة المادة لتقليل أثرها أو مخاطرها قبل التخلص أو الاستخدام المحدود، ولا تُحسب كتحويل دائري.", en: "Treating the material to reduce its impact or risks before disposal or limited use, not counted as circular diversion." },
  "pathway.certified_disposal.desc": { ar: "التخلص النظامي لدى جهة مرخصة أو وفق متطلبات تنظيمية، ولا يُحسب كتحويل دائري.", en: "Systematic disposal at a licensed entity or according to regulatory requirements, not counted as circular diversion." },
  "pathway.loss_rejected.desc": { ar: "جزء غير قابل للاستفادة أو مرفوض بعد الفرز أو المعالجة.", en: "An unusable or rejected part after sorting or processing." },
  "pathway.other.desc": { ar: "مسار غير مصنف ضمن الخيارات السابقة، ويتطلب توضيحاً.", en: "A pathway not classified under the previous options, requiring explanation." },
  "sustainability.allocations.no_pathways": { ar: "لا توجد مسارات مضافة بعد", en: "No pathways added yet" },
  "sustainability.allocations.col.material": { ar: "المادة", en: "Material" },
  "sustainability.allocations.col.quantity": { ar: "الكمية", en: "Quantity" },
  "sustainability.allocations.col.unit": { ar: "الوحدة", en: "Unit" },
  "sustainability.allocations.col.source": { ar: "المصدر", en: "Source" },
  "sustainability.allocations.col.eligibility": { ar: "الأهلية", en: "Eligibility" },
  "sustainability.allocations.col.status": { ar: "الحالة", en: "Status" },
  "sustainability.allocations.over_allocated": { ar: "تجاوزت الكمية الموزعة الحد المستلم", en: "Allocated quantity exceeds received total" },
  ...
  "sustainability.allocations.status.superseded": { ar: "مُستبدَلة", en: "Superseded" },
  "sustainability.allocations.status.needs_review": { ar: "تحت المراجعة", en: "Needs Review" },

  /* ── SIR-2D: Correction Workflow ── */
  "sustainability.correction.request_btn": { ar: "طلب تصحيح", en: "Request Correction" },
  "sustainability.correction.request_title": { ar: "طلب إعادة فتح كمسودة تصحيحية", en: "Request Correction Draft" },
  "sustainability.correction.request_desc": { ar: "سيتم إرسال طلبك إلى مسؤول تدويرة للمراجعة. بعد الموافقة، ستتمكن من تعديل بيانات التوزيع وإعادة اعتمادها. النسخة الحالية ستبقى نشطة حتى اعتماد المسودة التصحيحية.", en: "Your request will be reviewed by a Tadweerah admin. Once approved, you can edit and re-finalize the allocation data. The current version remains active until the correction draft is finalized." },
  "sustainability.correction.reason_label": { ar: "سبب التصحيح (مطلوب)", en: "Correction reason (required)" },
  "sustainability.correction.reason_placeholder": { ar: "اذكر سبب طلب التصحيح...", en: "Describe the reason for this correction..." },
  "sustainability.correction.submit": { ar: "إرسال الطلب", en: "Submit Request" },
  "sustainability.correction.submitting": { ar: "جاري الإرسال...", en: "Submitting..." },
  "sustainability.correction.success": { ar: "تم إرسال طلب التصحيح بنجاح. سيتم إبلاغك بقرار المسؤول.", en: "Correction request submitted. You will be notified of the admin's decision." },
  "sustainability.correction.duplicate": { ar: "يوجد طلب تصحيح معلّق لهذا السجل بالفعل.", en: "A pending correction request already exists for this allocation." },
  "sustainability.correction.draft_banner": { ar: "مسودة تصحيحية — النسخة", en: "Correction Draft — Version" },
  "sustainability.correction.superseded_label": { ar: "مُستبدَلة", en: "Superseded" },
  "sustainability.correction.version_label": { ar: "النسخة", en: "Version" },
  "sustainability.correction.pending_badge": { ar: "طلب تصحيح معلّق", en: "Pending Correction" },
  "sustainability.correction.request_status.pending": { ar: "معلّق", en: "Pending" },
  "sustainability.correction.request_status.approved": { ar: "موافق عليه", en: "Approved" },
  "sustainability.correction.request_status.rejected": { ar: "مرفوض", en: "Rejected" },

  /* ── SIR-2D: Admin Sustainability Tab ── */
  "admin.sustainability.tab": { ar: "الاستدامة", en: "Sustainability" },
  "admin.sustainability.col.commercial_ref": { ar: "المرجع التجاري", en: "Commercial Ref" },
  "admin.sustainability.col.company": { ar: "الشركة", en: "Company" },
  "admin.sustainability.col.material": { ar: "المادة", en: "Material" },
  "admin.sustainability.col.quantity": { ar: "الكمية", en: "Quantity" },
  "admin.sustainability.col.status": { ar: "الحالة", en: "Status" },
  "admin.sustainability.col.version": { ar: "النسخة", en: "Version" },
  "admin.sustainability.col.correction_status": { ar: "حالة التصحيح", en: "Correction Status" },
  "admin.sustainability.col.finalized_at": { ar: "تاريخ الاعتماد", en: "Finalized Date" },
  "admin.sustainability.col.actions": { ar: "إجراءات", en: "Actions" },
  "admin.sustainability.action.reopen": { ar: "إعادة فتح كمسودة تصحيحية", en: "Reopen as Correction Draft" },
  "admin.sustainability.action.approve": { ar: "موافقة", en: "Approve" },
  "admin.sustainability.action.reject": { ar: "رفض", en: "Reject" },
  "admin.sustainability.confirm.reopen": { ar: "ستؤدي هذه العملية إلى إنشاء مسودة تصحيحية جديدة. تبقى النسخة المعتمدة الحالية فعّالة حتى اعتماد المسودة التصحيحية. هل تريد المتابعة؟", en: "This will create a new correction draft. The current finalized version remains active until the correction draft is finalized. Continue?" },
  "admin.sustainability.confirm.approve": { ar: "ستؤدي الموافقة إلى إنشاء مسودة تصحيحية جديدة. تبقى النسخة المعتمدة الحالية فعّالة حتى اعتماد المسودة التصحيحية.", en: "Approving will create a new correction draft. The current finalized version remains active until the correction draft is finalized." },
  "admin.sustainability.reject.reason_label": { ar: "سبب الرفض (مطلوب)", en: "Rejection reason (required)" },
  "admin.sustainability.filter.pending_only": { ar: "طلبات التصحيح المعلّقة فقط", en: "Pending corrections only" },
  "admin.sustainability.empty": { ar: "لا توجد سجلات استدامة", en: "No sustainability records" },
  "admin.sustainability.load": { ar: "تحميل سجلات الاستدامة", en: "Load Sustainability Records" },
  "admin.notifications.bell_title": { ar: "إشعارات المسؤول", en: "Admin Notifications" },
  "admin.notifications.mark_all_read": { ar: "تحديد الكل كمقروء", en: "Mark all as read" },
  "admin.notifications.empty": { ar: "لا توجد إشعارات", en: "No notifications" },
