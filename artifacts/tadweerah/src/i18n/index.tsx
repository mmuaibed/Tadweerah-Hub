...
const translations: Record<string, Record<Language, string>> = {
  ...
  "deal.transport.smart.arrange_btn": { ar: "نعم، رتّبوا لي النقل عبر تدويرة", en: "Yes, Arrange Transport for Me" },
  "deal.transport.smart.skip_btn": { ar: "لا، سأرتب النقل بنفسي", en: "No, I'll Arrange It Myself" },
