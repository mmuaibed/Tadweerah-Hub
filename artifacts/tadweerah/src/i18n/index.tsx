...
const translations: Record<string, Record<Language, string>> = {
  ...
  "deal.role.processing": { ar: "قيد المعالجة", en: "Processing" },
  ...
  "deal.transport.smart.requested": { ar: "تم تسجيل طلب النقل", en: "Transport Request Registered" },
  "deal.transport.smart.requested_desc": { ar: "سيتم التنسيق قريبًا — سنتواصل معك في أقرب وقت.", en: "Coordination will begin shortly — we will follow up with you soon." },
  ...
  "deal.transport.smart.arrange_success": { ar: "تم تسجيل طلب النقل. سيتم التنسيق قريبًا.", en: "Transport request registered. Coordination will begin shortly." },
