...
const translations: Record<string, Record<Language, string>> = {
  ...
  "deal.transport.smart.desc": { ar: "هل تحتاج مساعدة في نقل المواد؟ يمكن لتدويرة مساعدتك في تنسيق طلب النقل.", en: "Need help moving the materials? Tadweerah can help coordinate your transport request." },
  "deal.transport.smart.arrange_btn": { ar: "رتّب النقل لي", en: "Arrange Transport for Me" },
  "deal.transport.smart.skip_btn": { ar: "لا أحتاج نقل", en: "I Don't Need Transport" },
  ...
  "deal.transport.smart.requested": { ar: "طلب النقل قيد التنسيق", en: "Transport request is being coordinated" },
  "deal.transport.smart.requested_desc": { ar: "سيتواصل معك فريق تدويرة أو أحد الناقلين المناسبين.", en: "Tadweerah team or a suitable carrier will contact you." },
  ...
  "deal.transport.smart.arrange_success": { ar: "تم إنشاء طلب النقل. سيتواصل معك فريق تدويرة أو أحد الناقلين المناسبين.", en: "Transport request created. Tadweerah team or a suitable carrier will contact you." },
